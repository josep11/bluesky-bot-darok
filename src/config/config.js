...
export const LIKE_INTERVAL_IN_SECONDS = 21 //QUANTIDADE EM SEGUNDOS PARA EFETUAR CADA LIKE -- FORTEMENTE SUGERIDO A DEIXAR MAIOR OU IGUAL A 15
/*****************************************************      LIKES     *********************************************************************************/

export const DETAILED_LOGS = true; // ATIVAR/DESATIVAR LOGS DETALADOS
